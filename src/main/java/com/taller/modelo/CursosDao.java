...
public class CursosDao {
    ...
    public List<Cursos> ListarCursos() {
        ...
        try (Connection conn = ConexionDatabase.getInstance().getConnection();
            ...
            System.err.println("Error obtenerTodosLosCursos: " + ex.getMessage());
        }
        return cursos;
    }
    ...
    public List<Cursos> listarCursosPorPeriodo(int periodo_academico_id) {
        ...
        try (Connection conn = ConexionDatabase.getInstance().getConnection();
            ...
            System.err.println("Error listarCursosPorDocente: " + ex.getMessage());
        }
        return cursos;
    }

    public boolean actualizarCurso(Cursos c) {
        boolean exito = false;
